...
const TopBar = () => {
  return (
    <div className="hidden lg:flex bg-dark-blue text-white py-6 md:py-3 px-6 flex-col md:flex-row justify-between items-center text-sm font-bold gap-4 md:gap-0">
